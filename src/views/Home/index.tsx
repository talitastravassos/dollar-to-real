  ...
  return (
    <div className={styles.container}>
      ...
      <p className="is-size-5">
        ...
        digitar no campo indicado o valor que deseja converter, a taxa do estado
        americano e selecionar o modo de pagamento (dinheiro ou cartão de
        crédito), logo abaixo irá aparecer o resultado do cálculo. 
      </p>
      <h3
      ...
      <ul>
        <li>
          - Sobre o IOF: é um imposto federal sobre operações de crédito, câmbio
          e seguros.
        </li>
        <li>
